...
return [
    ...
    'workflow' => [
        ...
        'help' => [
            ...
            'work_targets2' => 'このアクションを実行できるユーザーの種類を選択します。<br />「前アクションの実行ユーザーが選択」：前のアクションを実行したユーザーが、このアクションを実行するユーザーを選択<br />「事前に設定」は、特定のユーザーや組織のみ実行<br />「上長」：ユーザーテーブル・組織テーブル内の、指定のユーザー列・組織列を対象に実行',
